...
import TherapistTasks from './routes/TherapistTasks';
import PatientTasks from './routes/PatientTasks';
      ...
      <Router>
        <Routes>
          ...
          <Route path="/patient-tasks" element={
            <ProtectedRoute allowedRoles={['patient']}>
              <Layout><PatientTasks /></Layout>
            </ProtectedRoute>
          } />

          <Route path="/therapist-tasks" element={
            <ProtectedRoute allowedRoles={['therapist']}>
              <Layout><TherapistTasks /></Layout>
            </ProtectedRoute>
          } />
        </Routes>
      </Router>
